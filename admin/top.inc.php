         ...
         <header id="header" class="header">
            <div class="top-left">
               <div class="navbar-header">
                  <a class="navbar-brand" href="index.php" style="color:white"><h2>ZAK apple store</h2></a>
                  <a class="navbar-brand hidden" href="index.php"style="color:white"><h2>ZAK apple store</h2></a>
            ...
            <div class="top-right">
               <div class="header-menu">
                  <div class="user-area dropdown float-right">
                     <a href="#" class="dropdown-toggle active" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="color:white">Welcome <?php echo $_SESSION['ADMIN_USERNAME']?></a>
